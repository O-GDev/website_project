...
export default function BlogListStyledPage(){
  return (
    <>
                        ...
                        <div className="blog-list-content">
                            ...
                            <div className="pagination-wrapper pt_20">
                                <ul className="pagination clearfix">
                                    <li><Link to="/blog-4"><i className="flaticon-next"></i></Link></li>
                                    <li><Link to="/blog-4">01</Link></li>
                                    <li><Link to="/blog-4">02</Link></li>
                                    <li><Link to="/blog-4">03</Link></li>
                                    <li><Link to="/blog-4"><i className="flaticon-next"></i></Link></li>
                                </ul>
                            </div>
                        </div>
