...
export default function SeniorCitizenAccountPage(){
  return (
    <>
    ...
    <div className="boxed_wrapper">
        ...
        <OverviewSection h2="Citizen Accounts" eligibility="Citizen Account Eligibility" />
        


        
        <FeaturesSection heading="Key Citizen Account Features" />
