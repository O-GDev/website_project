    ...
    <div className="boxed_wrapper">
        ...
        <section className="custom-banking sec-pad bg-color-1">
            ...
            <div className="auto-container">
                ...
                <Tabs className="tabs-box">
                    <figure className="support-image"><img loading="lazy" src="/assets/images/resource/men-1.png" alt="" /></figure>
        ...
        <section className="calculator-section pt_120 pb_120">
            <figure className="image-layer"><img loading="lazy" src="/assets/images/resource/men-2.jpeg" alt="" /></figure>
