              ...
              <div className="footer-widget links-widget ml_75">
                ...
                <div className="widget-content mb_25">
                  <ul className="links-list clearfix">
                    ...
                    <li><Link to="/">Awards & Recognition<i className="flaticon-next"></i></Link></li>
                    <li><Link to="/team">Leadership<i className="flaticon-next"></i></Link></li>
                    <li><Link to="/blog">News & Media<i className="flaticon-next"></i></Link></li>
                  </ul>
                </div>
                <div className="widget-title">
                  <h3>Support</h3>
              ...
              <div className="footer-widget links-widget ml_90">
                ...
                <div className="widget-content">
                  <ul className="links-list clearfix">
                    ...
                    <li><Link to="/cards">Credit Cards<i className="flaticon-next"></i></Link></li>
                    <li><Link to="/loans-1">Loans<i className="flaticon-next"></i></Link></li>
                    <li><Link to="/">Locker<i className="flaticon-next"></i></Link></li>
                    <li><Link to="/cards">Money Transfer<i className="flaticon-next"></i></Link></li>
                    <li><Link to="/investments-details-6">Investments<i className="flaticon-next"></i></Link></li>
                    <li><Link to="/investments-details-4">Insurance<i className="flaticon-next"></i></Link></li>
        ...
        <div className="auto-container">
          ...
          <div className="bottom-inner">
            ...
            <div className="footer-logo">
              ...
              <div className="copyright"><p>copyrights <Link to="/">&copy; 2025 Flexibank.</Link> All Rights Reserved.</p></div>
            </div>
