                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 testimonial-block">
                        ...
                        <div className="testimonial-block-one">
                            <div className="inner-box">
                                ...
                                <div className="icon-box"><img src="/assets/images/icons/icon-121.png" alt="" /></div>
                                <h3>User Friendly</h3>
                                <p>This debit card has transformed my shopping experience with amazing rewards & transactions.</p>
                                <div className="author-box">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 testimonial-block">
                        <div className="testimonial-block-one">
                            <div className="inner-box">
                                ...
                                <div className="icon-box"><img src="/assets/images/icons/icon-121.png" alt="" /></div>
                                <h3>User Friendly</h3>
                                <p>Exceptional service and user-friendly online banking. I’ve never had a smoother experience with any other bank like kaizenbank.</p>
                                <div className="author-box">
