            ...
            <Tabs className="tabs-box">
              ...
              <div className="tab-btn-one">
                <ul className="tab-btns tab-buttons clearfix">
                  <li className="tab-btn active-btn" data-tab="#tab-9">
                    Business
                  </li>
                  <li className="tab-btn" data-tab="#tab-10">
                    Individual
                  </li>
                </ul>
              </div>
                          ...
                          <div className="tab-2" id="tab-12">
                            <div className="content-box">
                              <div className="title-box">
                                ...
                                <h4>Consumer Loans</h4>
                                <h2>
                                  Flexibank in Your Future, Consumer Loans.
                                </h2>
                              </div>
                              <div className="inner-box">
                                <p>
                          ...
                          <div className="tab-2" id="tab-14">
                            <div className="content-box">
                              <div className="title-box">
                                ...
                                <h4>Advisory Services</h4>
                                <h2>
                                  Flexibank is Provided, Advisory Services.
                                </h2>
                              </div>
                              <div className="inner-box">
                                <p>
                          ...
                          <div className="tab-2" id="tab-15">
                            <div className="content-box">
                              <div className="title-box">
                                ...
                                <h4>Insurance Products</h4>
                                <h2>
                                  Flexibank is Protected, Your life Insurance.
                                </h2>
                              </div>
                              <div className="inner-box">
                                <p>
                          ...
                          <div className="tab-2" id="tab-51">
                            <div className="content-box">
                              <div className="title-box">
                                ...
                                <h2>
                                  Flexibank is Protected, Your Savings Account.
                                </h2>
                              </div>
                              <div className="inner-box">
                                <p>
              ...
              <Tabs className="tabs-box">
                <div className="tab-btn-box">
                  <div className="tab-btns tab-buttons clearfix">
                    <div className="tab-btn active-btn" data-tab="#tab-21">
                      <h4>Kaizen Personal Loan</h4>
                    </div>
                    <div className="tab-btn" data-tab="#tab-22">
                      <h4>Kaizen Enterprise Loan</h4>
                    </div>
                    <div className="tab-btn" data-tab="#tab-23">
                      <h4>Kaizen Asset Loan</h4>
                    </div>
                    <div className="tab-btn" data-tab="#tab-24">
                      <h4>Kaizen Micro Loan</h4>
                    </div>
                  </div>
                </div>
                <div className="tabs-content">
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12 left-column">
                              <div className="left-content mr_30">
                                <div className="sec-title">
                                  ...
                                  <p>
                                    Estimate your loan payments quickly & easily
                                    with our calculator.
                                  </p>
                                </div>
                                <div className="lower-text">
                                  <div className="icon-box">
                                    <img
                                      loading="lazy"
                                      src="/assets/images/icons/icon-31.png"
                                      alt=""
                                    />
                                  </div>
                                  <h5>
                                    Loan Questions? Check Our{" "}
                                    <Link to="/faq">Faq’s</Link> Page.
                                  </h5>
                                </div>
                              </div>
                            </div>
