                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div className="blog-list-content">
                            <div className="news-block-one">
                                <div className="inner-box">
                                    <div className="image-box">
                                        <figure className="image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-23.jpg" alt="" /></Link></figure>
                                        <figure className="overlay-image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-23.jpg" alt="" /></Link></figure>
                                        <div className="view-btn"><a href="/assets/images/news/news-23.jpg" className="lightbox-image" data-fancybox="gallery"><img loading="lazy" src="/assets/images/icons/icon-87.png" alt="" /></a></div>
                                    </div>
                                        ...
                                        <div className="lower-box">
                                            ...
                                            <div className="link-box">
                                                <ul className="post-info">
                                                    ...
                                                    <li><h5><img loading="lazy" src="/assets/images/icons/icon-212.png" alt="" />345 Views</h5></li>
                                                </ul>
                            ...
                            <div className="news-block-one">
                                <div className="inner-box">
                                    <div className="image-box">
                                        <figure className="image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-24.jpg" alt="" /></Link></figure>
                                        <figure className="overlay-image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-24.jpg" alt="" /></Link></figure>
                                        <div className="view-btn"><a href="/assets/images/news/news-24.jpg" className="lightbox-image" data-fancybox="gallery"><img loading="lazy" src="/assets/images/icons/icon-87.png" alt="" /></a></div>
                                    </div>
                                    <div className="content-box">
                                        <div className="upper-box">
                                            <div className="title-box">
                                        ...
                                        <div className="lower-box">
                                            ...
                                            <div className="link-box">
                                                <ul className="post-info">
                                                    ...
                                                    <li><h5><img loading="lazy" src="/assets/images/icons/icon-212.png" alt="" />186 Views</h5></li>
                                                </ul>
                                                <Link to="/blog-details"><i className="flaticon-right-arrow"></i></Link>
                                            </div>
                                        </div>
                            ...
                            <div className="news-block-one">
                                <div className="inner-box">
                                    <div className="image-box">
                                        <figure className="image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-25.jpg" alt="" /></Link></figure>
                                        <figure className="overlay-image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-25.jpg" alt="" /></Link></figure>
                                        <div className="view-btn"><a href="/assets/images/news/news-25.jpg" className="lightbox-image" data-fancybox="gallery"><img loading="lazy" src="/assets/images/icons/icon-87.png" alt="" /></a></div>
                                    </div>
                                    <div className="content-box">
                                        <div className="upper-box">
                                            <div className="title-box">
                                        ...
                                        <div className="lower-box">
                                            ...
                                            <div className="link-box">
                                                <ul className="post-info">
                                                    ...
                                                    <li><h5><img loading="lazy" src="/assets/images/icons/icon-212.png" alt="" />45 Views</h5></li>
                                                </ul>
                                                <Link to="/blog-details"><i className="flaticon-right-arrow"></i></Link>
                                            </div>
                                        </div>
                            ...
                            <div className="news-block-one">
                                <div className="inner-box">
                                    <div className="image-box">
                                        <figure className="image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-26.jpg" alt="" /></Link></figure>
                                        <figure className="overlay-image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-26.jpg" alt="" /></Link></figure>
                                        <div className="view-btn"><a href="/assets/images/news/news-26.jpg" className="lightbox-image" data-fancybox="gallery"><img loading="lazy" src="/assets/images/icons/icon-87.png" alt="" /></a></div>
                                    </div>
                                    <div className="content-box">
                                        <div className="upper-box">
                                            <div className="title-box">
                            ...
                            <div className="news-block-one">
                                <div className="inner-box">
                                    <div className="image-box">
                                        <figure className="image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-27.jpg" alt="" /></Link></figure>
                                        <figure className="overlay-image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-27.jpg" alt="" /></Link></figure>
                                        <div className="view-btn"><a href="/assets/images/news/news-27.jpg" className="lightbox-image" data-fancybox="gallery"><img loading="lazy" src="/assets/images/icons/icon-87.png" alt="" /></a></div>
                                    </div>
                                    <div className="content-box">
                                        <div className="upper-box">
                                            <div className="title-box">
                            ...
                            <div className="news-block-one">
                                <div className="inner-box">
                                    <div className="image-box">
                                        <figure className="image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-28.jpg" alt="" /></Link></figure>
                                        <figure className="overlay-image"><Link to="/blog-details"><img loading="lazy" src="/assets/images/news/news-28.jpg" alt="" /></Link></figure>
                                        <div className="view-btn"><a href="/assets/images/news/news-28.jpg" className="lightbox-image" data-fancybox="gallery"><img loading="lazy" src="/assets/images/icons/icon-87.png" alt="" /></a></div>
                                    </div>
                                    <div className="content-box">
                                        <div className="upper-box">
                                            <div className="title-box">
