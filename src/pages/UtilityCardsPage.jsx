                    ...
                    <div className="col-lg-3 col-md-12 col-sm-12 sidebar-side">
                        <div className="cards-sidebar pt_110 pb_120">
                            <div className="contact-widget">
                                <div className="inner-box" style={{backgroundImage: 'url(/assets/images/banner/holdingutility.png)'}}>
                                ...
                                <div className="image-box">
                                    <div className="row clearfix">
                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                            <figure className="image"><img src="/assets/images/banner/utility.png" alt="Utility card" /></figure>
                                        </div>
                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                    ...
                                    <li className="accordion block active-block">
                                        ...
                                        <div className="acc-content current">
                                            <div className="content">
                                                ...
                                                <Link to="/card-details-utility"><span>Check Eligibility</span></Link>
                                            </div>
                                        </div>
                                    </li>
